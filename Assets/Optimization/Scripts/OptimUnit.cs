...
public class OptimUnit : MonoBehaviour
{
    ...
    void Update()
    {
        Profiler.BeginSample("Handle Time"); // Begin profiling a piece of code with a custom label
        HandleTime();
        Profiler.EndSample(); // End the current profiling sample
        ...
        Profiler.EndSample(); // End the profiling sample for rotation

        Profiler.BeginSample("Moving");

        Move();

        Profiler.EndSample(); // End the profiling sample for movement
        ...
        Profiler.EndSample(); // End the profiling sample for boundary check
    }
